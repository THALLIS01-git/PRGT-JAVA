...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            String caminhoHtmlLocal = "C:\\Users\\Tiago\\Desktop\\PRGT-JAVA\\mao trabalho bio\\Portal\\index.html";
            ...
            while (janela.isVisible()) {
                ...
                if (pixelsPele > 8000) {
                    ...
                    opencv_imgproc.putText(imagemMat, "MAO DETECTADA",
                            new org.bytedeco.opencv.opencv_core.Point(50, 40),
                    ...
                    opencv_imgproc.putText(imagemMat, "Aguardando...",
                            new org.bytedeco.opencv.opencv_core.Point(50, 40),
